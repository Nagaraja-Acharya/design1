...
const timeline = [
  ...
  },
  {
    ...
    description: "Scholarship program worth ₹2 lakh provided to 25+ students. School vehicles with drivers provided for students from distant areas. ID cards distributed, uniforms provided to LKG and UKG students for two consecutive years, and ₹25,000 allocated for educational trips.",
  },
  {
    year: "2024-2025",
